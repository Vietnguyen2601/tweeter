...
config()
const uri = `mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@tweetprojectk18.adtmh1l.mongodb.net/?retryWrites=true&w=majority`
...
class DatabaseService {
  ...
  async indexUsers() {
    ...
    await this.users.createIndex({ email: 1, username: 1 }) //login
  }
